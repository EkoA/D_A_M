...
<div class="col-sm-12">
    <div class="card-box">
      <h5 class="m-t-0 header-title"><b>Request For an Item</b></h5>
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('basic.update', $order->id) }}">
                        {{ csrf_field() }}
                        {{ method_field('PUT') }}
                        ...
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                <input id="description" type="description" class="form-control" name="description" value="{{$order->description}}" required></textarea>
                        ...
                        <div class="form-group{{ $errors->has('role_id') ? ' has-error' : '' }}">
                          ...
                          <div class="col-md-10">
                                <input id="quantity" type="number" class="form-control" name="quantity"  value="{{$order->quantity}}" min="1" required>
                                ...
                                @endif
												...
												<div class="form-group{{ $errors->has('cost') ? ' has-error' : '' }}">
													...
													<div class="col-md-10">
																<input id="cost" type="number" class="form-control" name="cost" step="any" value="{{$order->cost}}" min="1" required>
