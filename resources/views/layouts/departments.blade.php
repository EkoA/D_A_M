          ...
          <div class="container">
              <div class="">
                  ...
                  <ul class="nav navbar-nav hidden-xs">
                      <li><a href="{{ url('departments') }}" style="font-family: inherit;
">&nbsp;&nbsp;&nbsp;All Requests</a></li>
                       <li><a href="{{ url('departments/pending') }}" style="font-family: inherit;
      ...
      <div class="sidebar-inner slimscrollleft">
          ...
          <div id="sidebar-menu">
              <ul>
                  ...
                  <li class="has_sub">
                      <a href="{{ url('/departments') }}" class="waves-effect"><i class="ti-home"></i> Dashboard </a>
                  </li>
                  <li class="has_sub">
                      <a href="{{ url('/departments') }}" class="waves-effect"><i class="ti-pencil-alt"></i>All Requests</a>
                  </li>
                  <li class="has_sub">
                      <a href="{{ url('departments/pending') }}" class="waves-effect"><i class="ti-pencil-alt"></i>Pending Requests</a>
                  </li>
                  <li class="has_sub">
                      <a href="{{ url('/departments/create') }}" class="waves-effect"><i class="fa fa-plus"></i>Request Item</a>
                  </li>
                  @if(Auth::user()->role_id == "HOD" && Auth::user()->department == "HUMAN CAPITAL")
                  <li class="has_sub">
