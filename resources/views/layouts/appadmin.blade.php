    ...
    <div class="sidebar-inner slimscrollleft">
        ...
        <div id="sidebar-menu">
            <ul>
                ...
                <li class="has_sub">
                    <a href="{{ url('/users') }}" class="waves-effect"><i class="ti-pencil-alt"></i>Manage Staff</a>
                </li>
                <li class="has_sub">
                    <a href="{{ url('/orders') }}" class="waves-effect"><i class="ti-pencil-alt"></i>Manage Requests</a>
                </li>
                <li class="has_sub">
                    <a href="{{ url('/asset') }}" class="waves-effect"><i class="ti-pencil-alt"></i>Manage Assets</a>
                </li>
            </ul>
