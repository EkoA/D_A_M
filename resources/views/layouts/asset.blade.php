    ...
    <div class="sidebar-inner slimscrollleft">
        ...
        <div id="sidebar-menu">
            <ul>
                ...
                <li class="has_sub">
                    <a href="{{ url('/asset') }}" class="waves-effect"><i class="ti-pencil-alt"></i>View Asset</a>
                </li>
                <li class="has_sub">
                    <a href="{{ url('/asset/create') }}" class="waves-effect"><i class="ti-plus"></i>Add Asset</a>
                </li>
                <li class="has_sub">
                    <a href="{{ url('/asset/pending') }}" class="waves-effect"><i class="ti-pencil-alt"></i>Pending Assets</a>
                </li>
                <li class="has_sub">
                    <a href="{{ url('/asset/disposalpending') }}" class="waves-effect"><i class="ti-pencil-alt"></i>Pending Asset Disposal</a>
                </li>
            </ul>
