...
">&nbsp;&nbsp;&nbsp;Manage Vendors</a></li>
                    ...
                    <ul class="nav navbar-nav navbar-right pull-right">
                        ...
                        <li class="dropdown top-menu-item-xs">
                            <a class="profile waves-effect waves-light"  href="{{ url('/logout') }}"><i class="ti-power-off m-r-10 text-danger"></i>Logout</a>
                        </li>
                    </ul>
                    @endif
                </div>
          ...
          <div class="sidebar-inner slimscrollleft">
              ...
              <div id="sidebar-menu">
                  <ul>
                      ...
                      <li class="has_sub">
                          <a href="{{ url('/basic/sent') }}" class="waves-effect"><i class="ti-pencil-alt"></i>View Requests</a>
                      </li>
                      <li class="has_sub">
                          <a href="{{ url('/orders/create') }}" class="waves-effect"><i class="ti-plus"></i>Make Request</a>
                      </li>
                  </ul>
