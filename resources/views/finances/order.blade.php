...
<div class="col-sm-12">
		<div class="card-box">
			<h5 class="m-t-0 header-title"><b>Request Form</b></h5>
			<?php
					//$ret = $_GET["ret"];
					if(isset($_GET["res"]))
					{
			...
			@if(isset($_GET["res"]))
				<center>
							<h4 style="color:red;"><?php echo $res; ?></h4>
				</center>
			@endif
                          ...
                          <div class="col-md-10">
                                ...
                                @endif
												...
												<div class="form-group{{ $errors->has('cost') ? ' has-error' : '' }}">
													...
													<div class="col-md-10">
																<input id="cost" type="number" class="form-control" name="cost"  value="1" min="1" required>
                            ...
                            <input id="finance_approval" type="hidden" class="form-control" name="finance_approval" value="APPROVAL" required>
                            <input id="hod_approval" type="hidden" class="form-control" name="hod_approval" value="APPROVAL" required>
